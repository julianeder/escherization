...
[ "_main", "getExceptionMessage", "___get_exception_message", "_free", "_memory", "__Z7doMorphiiNSt3__26vectorIhNS_9allocatorIhEEEE", "___indirect_function_table", "_fflush", "onRuntimeInitialized" ].forEach(prop => {
...
if (Module["locateFile"]) {
 wasmBinaryFile = "wasmMorph.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("wasmMorph.wasm", import.meta.url).href;
}
...
var __Z7doMorphiiNSt3__26vectorIhNS_9allocatorIhEEEE = Module["__Z7doMorphiiNSt3__26vectorIhNS_9allocatorIhEEEE"] = createExportWrapper("_Z7doMorphiiNSt3__26vectorIhNS_9allocatorIhEEEE");
